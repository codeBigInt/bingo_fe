        ...
        <div className='justify-between py-6 md:px-20 px-6 flex items-center w-full md:bg-[#fffdfd]'>
            ...
            <div className='md:flex hidden gap-6 items-center'>
                ...
                <div className='flex gap-4 items-center'>
                    <button className='bg-[#FAD02C] shadow-[inset_2px_2px_0px_0px_rgba(255,255,255,0.4),_inset_-4px_-4px_0px_0px_rgba(0,0,0,0.32)] text-white py-2 px-4 rounded-[8px]'>Login</button>
                    <button className='bg-[#00658B] shadow-[inset_2px_2px_0px_0px_rgba(255,255,255,0.4),_inset_-4px_-4px_0px_0px_rgba(0,0,0,0.32)] text-white py-2 px-4 rounded-[8px]'>Signup</button>
                </div>
            </div>
