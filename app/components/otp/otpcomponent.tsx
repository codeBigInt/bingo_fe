...
const OtpComponent: React.FC<OtpComponentProps> = ({ email }) => {
  ...
  return (
    <div className="bg-transparent w-fill py-[50px] flex justify-center flex-col items-center text-[#00222E] text-center">
      ...
      <Button
        ...
        color="primary"
        className="shadow-[inset_2px_2px_0px_0px_rgba(255,255,255,0.4),_inset_-4px_-4px_0px_0px_rgba(0,0,0,0.32)] bg-[#FD0] hover:bg-[#FD0] border-1 border-[#665800] rounded-md w-[50%]"
      >
        Verify
      </Button>
    </div>
